...
public class StageManager : MonoBehaviour
{
    ...
    private void SummonEnemy()
    {
        ...
        GameObject hpBar = ObjectPoolManager.instance.GetObject("HPBar");
        hpBar.transform.SetParent(hpCanvas.transform);
        HPBar mHPBar = hpBar.GetComponent<HPBar>();
        mHPBar.SetTarget(enemy.transform);
        enemy.GetComponent<MonsterController>().SetHPBar(mHPBar);
